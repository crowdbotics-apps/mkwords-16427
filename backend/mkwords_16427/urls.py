"""mkwords_16427 URL Configuration
...
admin.site.site_header = "MKWORDS"
admin.site.site_title = "MKWORDS Admin Portal"
admin.site.index_title = "MKWORDS Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="MKWORDS API",
        default_version="v1",
        description="API documentation for MKWORDS App",
    ),
    public=True,
